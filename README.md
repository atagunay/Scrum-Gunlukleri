...
Bu el kitabı **J.J. Sutherland**’ in yazarı olduğu **“Scrum: The Art of Doing Twice the Work in Half the Time”** kitabından çıkardığım notları derlediğim bir derlemedir.
...
Scrum ise, **J.J. Sutherland tarafından yukarıdaki değerleri uygulamak için geliştirilen bir yöntemdir.**

![https://cdn-images-1.medium.com/max/800/1*33dMoN9X6EGuGUGGn6-stA.png](https://cdn-images-1.medium.com/max/800/1*33dMoN9X6EGuGUGGn6-stA.png)

---

# Scrum’ ın Temelinde Yatan Bazı Önemli Düşünceler

### 1. Planning Is Useful. Blindly Following Plans Is Stupid (Planlama Faydalıdı. Körü Körüne Planlama Aptallıktır)
...
Kısa geliştirme döngüleri (ör: 1-2 hafta) ile hayat geçirilen bir ürün erken kullanıcı geri dönüşleri sağlar. Bu geri dönüşler sizi kullanılmayacak özellikler için boşuna zaman harcamaktan alıkoyar.

### **3. Plan, Do, Check, Act (Planla, Yap, Kontrol Et, Harekete Geç)**

Bir plan yap ve bu planı harekete geçir. Daha sonrasında yaptığın işin sonuçlarını gözlemle. Geliştirmen gereken yerleri tespit et ve yeniden harekete geç.

![https://cdn-images-1.medium.com/max/800/1*hD2aPU_pq0ghEAf8f0vNLw.png](https://cdn-images-1.medium.com/max/800/1*hD2aPU_pq0ghEAf8f0vNLw.png)
...
![https://cdn-images-1.medium.com/max/800/1*zEoUzQfESfn089eD7_Xk5A.png](https://cdn-images-1.medium.com/max/800/1*zEoUzQfESfn089eD7_Xk5A.png)
...
1. Her gün gittiğiniz bu yerler için en ideal rotanızı nasıl oluşturdunuz? PDCA döngüsünü farkında olmadan veya bilinçli kullandınız mı?
2. Eğer kullanmadıysanız, kullanmış olsaydınız hayatını nasıl etkilerdi? Deneme yanılma sayınızı azaltır mıydı? En ideal rotayı daha hızlı mı bulurdunuz? Bulduğunuz rotanın en ideal rota olduğundan daha çok mu emin olurdunuz?
...
Farklı sektörlerden yaklaşık 3.800 civarı projenin incelenmesi sonucu Yale Üniversitesi’ nde olduğu gibi en iyi ekiplerin en kötü ekiplere kıyasla 10 kat daha hızlı olmaları beklenirken en iyi ekiplerin bir haftada tamamladığı işleri en kötü ekipler iki bin haftada tamamlamıştır.
...
1960' larda Yale Üniversitesinde Dr. Stanley Milgram tarafından insanların otorite içerisindeki davranışlarını inceleyen bu deney şöyle yapılmaktaydı:

![https://cdn-images-1.medium.com/max/800/1*Kc2U_j10HzEh34W0mLO6UQ.png](https://cdn-images-1.medium.com/max/800/1*Kc2U_j10HzEh34W0mLO6UQ.png)
...
Bu deney sınıflarda tartışıldığında o suçu işleyenini insanların kendilerinden ziyade sıradan insanların içinde olduğu öğrencilere gösterilir. Fakat içselleştirilmesi zor bir derstir.
...
### 1. Don’t Hate the Player, Hate the Game (Oyunculardan değil oyundan nefret edin)

Ekip performansını değiştirin. Bunun bireysel performanstan çok daha fazla etkisi vardır.

### 2. Blame Is Stupid (Suçlamak Aptallıktır)

Kötü insanları aramayın, kötü sistemleri (kötü davranışı teşvik eden ve düşük performansı ödüllendiren) arayın.
...
![https://cdn-images-1.medium.com/max/800/1*uTzalK1MnMbiWTJyLfd9jw.png](https://cdn-images-1.medium.com/max/800/1*uTzalK1MnMbiWTJyLfd9jw.png)
...
Tahta bir kaç sütuna bölünür. Şimdilerde bunun için bir çok uygulama var. O yüzden gidip bir tahta siparişi vermeyin.
...
2. Devam Eden
3. Tamamlanan
- Her Sprint, ekibin üyeleri o hafta tamamlayabileceklerini düşündükleri yapışkan kağıtları “İş Listesi” alanına koyarlar.
...
Herkesi bir odada toplamak çok önemlidir. Eğer bir kişi sorun karşısında tıkanıp kalmışsa herkes bu engelin tüm Sprint’ i tıkayacağını görüyor ve onun üzerine üşüşüyor ve öncelikle onun düzeltilmesini sağlıyordu.
...
![https://cdn-images-1.medium.com/max/800/1*L-VRH63b4bb7z7Vx1TenDg.png](https://cdn-images-1.medium.com/max/800/1*L-VRH63b4bb7z7Vx1TenDg.png)

---

# Scrum’ da İsraf Bir Suçtur

Çeşitli yollar ile çeşitli şeyleri israf edebiliriz. Zaman, enerji, para, vb. Peki israf etmemek için neler yapabiliriz?
...
Birden 1' den 10' a kadar rakamları, Roma rakamlarını ve de A’ dan H’ ye kadar harfleri yukarıdan aşağıya doğru yazın. Ancak ilk seferde önce rakamı, sonra roma rakamını sonra da harfi yazın ve kağıt şu şekilde görünsün:
...
Gerald Weinberg tarafından kaleme alınan “Quality Software Management” da harika bir çizelge mevcuttur.

![https://cdn-images-1.medium.com/max/800/1*-w_Yp-gUTA-yUGWJhc5xfQ.png](https://cdn-images-1.medium.com/max/800/1*-w_Yp-gUTA-yUGWJhc5xfQ.png)
...
![https://cdn-images-1.medium.com/max/800/0*sJzTiULlWFMP9QVZ.png](https://cdn-images-1.medium.com/max/800/0*sJzTiULlWFMP9QVZ.png)
...
Buradan hareketle yeterli enerji stoğumuz kalmadığında sağlıksız kararlar vermeye başlama durumunda olabiliriz. Yani herhangi bir günde verebileceğimiz sağlıklı karar sayısının bir limiti vardır ve daha fazla yapmaya devam ettikçe hatalar yapmaya başlarız.

---

# Scrum’ da Planlama

Her zaman elimizde yapılması gereken işler olacaktır ve biz çeşitli varsayımlarda bulunmak için bazı şeyleri ölçmek zorundayızdır. Örnek olarak işlerin önceliklendirmesi verilebilir. Belki bir önceliklendirme yapmak için o işin büyüklüğünün ne olduğunu bilmeniz size avantaj sağlayabilir. İşte bu ve benzeri durumlar için “Planlama Pokeri” olarak bilinen kesin bir tahmin toplama yöntemi kullanılır.

![https://cdn-images-1.medium.com/max/800/0*TYyS-1aQhwhQiyrk.png](https://cdn-images-1.medium.com/max/800/0*TYyS-1aQhwhQiyrk.png)
...
3. Herkes gerekli **çaba miktarını** temsil ettiğini düşündüğü kartı çeker ve masaya yüzü kapalı konur.
4. Aynı anda herkes kartları açar.
5. Eğer herkes diğerlerinin iki kart veya daha fazla yakınında ise (örneğin bir 5, iki 8 ve bir 13) ekip sadece sayıları toplar ve ortalamasını alır.
...
Bu yöntem tüm ekibin belirli bir göreve bilgi paylaşmasına izin verir. Fakat önemli olan işi gerçekten yapanların tahmin etmesini saplamanızdır, uzman tahmincilerin değil. Böyle [Halo Etkisi](https://evrimagaci.org/halo-etkisi-nedir-insanlar-neden-kitabi-kapagiyla-yargiliyor-11610)’ nden de kurtulmuş olursunuz.

> Haftanın sonunda tamamladığımız tüm hikayelerin tahmin edilen sayıları toplanır ve bu sayı bize ekibin ne kadar hızla ilerlediğini yani hızını söyler.
> 
...
İhtiyaçlar genellikle değişik karakterlerle birlikte değişecektir. Örneği şöyle biten bir cümle hayal edin: “… işe gidip gelebileceğim bir araba istiyorum” Şimdi, eğer o cümleye “Tekirdağda bir çiftçi olarak” yerine “İstanbul Kadıköy’ de yaşayan biri olarak” başlarsanız taşıtın ne olacağı konusunda farklı fikirleriniz olabilir. Bu sebeple bir hikaye (görev) alırken bu soruların cevaplarının olması size avantaj sağlayacaktır.

![https://cdn-images-1.medium.com/max/800/0*7qfaK4kH1dX_Ru7P.png](https://cdn-images-1.medium.com/max/800/0*7qfaK4kH1dX_Ru7P.png)
...
Scrum’ da altın anahtar “[Pareto İlkesi: 80/20 Kuralı”](https://evrimagaci.org/pareto-ilkesi-8020-kurali-nedir-sonuclarin-80i-gercekten-nedenlerin-20sinden-kaynaklanir-mi-11116) bilmektir. Çok kısaca özetlemek gerekirse Scrum’ da önceliklendirme yapmamızın amacı en az çaba ile en fazla değeri sağlayacak geliştirmeleri bulmak ve derhal gerçekleştirmek.

Bunun için yaptığınız işte hem vizyonun ne olduğu hem de değerlerin nerede olduğunu keşfedebilecek birine ihtiyacını olur. Scrum’ da bu kişiye Ürün Sahibi (Product Owner) denir.

![https://cdn-images-1.medium.com/max/800/1*0nuVFcCBrakYX8a6-HtCxQ.png](https://cdn-images-1.medium.com/max/800/1*0nuVFcCBrakYX8a6-HtCxQ.png)
...
![https://cdn-images-1.medium.com/max/800/0*6Y-_gmr6Sh7H6ndb.jpg](https://cdn-images-1.medium.com/max/800/0*6Y-_gmr6Sh7H6ndb.jpg)

### Product Owner Ne Yapar?

Ürün sahibi ya da Product Owner zamanının yarısını ürünü satın alan kişilerle konuşarak (en son geliştirilen parça/özellik ve bunun nasıl değer kattığı hakkında düşüncelerini alarak), diğer yarısını da İş Listesini (müşterilerin neye değer verdiğini ve vermediğini göstererek) yaratmakta olan ekiple geçirir.
...
4. **Ürün sahibi değer konusunda sorumlu olmaldır.** Ölçemediğini yönetemezsin sözü boşuna söylenmemiş olsa gerek ki ürün sahipleri ekiplerin üretimi ve değerleri arasında bir ilişki kurarak çeşitli ölçümler yapmak durumundadır. Eğer bir e-ticaret siteniz varsa sizin için değe=gelir olabilirken bir karakol çalışasını iseniz değer=yakalanan suçlu sayısı olarak baz alınabilir. Önemli olan bu değerlerin ölçülmesidir.

### Piyasaya Sürmek

Şimdi önceliklerimizi hallettiğimizi varsayalım. Değerin yüzde 80' inin nerede olduğunu biliyoruz. (“[Pareto İlkesi: 80/20 Kuralı”](https://evrimagaci.org/pareto-ilkesi-8020-kurali-nedir-sonuclarin-80i-gercekten-nedenlerin-20sinden-kaynaklanir-mi-11116)). Şimdi ürünü piyasaya sürme sırası. Scrum’ da özelliklerin henüz yüzde 20' si tamamlanmadan kullanıcılar ile buluşturulması önerilmektedir. Kullanıcılar ile buluşan bu ilk ürüne MVP (Minimum Viable Product) olarak adlandırırız. Türkçeye “En Küçük Geçerli Ürün” olarak çevirilenebilir.

![https://cdn-images-1.medium.com/max/800/0*DqOJJtd20MC9l-RK.jpeg](https://cdn-images-1.medium.com/max/800/0*DqOJJtd20MC9l-RK.jpeg)
...
- İnsanlar bir kez ürününüzü, hizmetinizi ya daha yarattığınız değişikliği hayatlarına aldıklarında size neyin bir sonraki şey olduğunu söyleyeceklerdir.
- Daha sonra yüzde 20' sini geliştirin ve tekrar teslim edin.

![https://cdn-images-1.medium.com/max/800/1*3swCwraqey_CJlyFlqEBeA.png](https://cdn-images-1.medium.com/max/800/1*3swCwraqey_CJlyFlqEBeA.png)
...
![https://cdn-images-1.medium.com/max/800/0*ppOSGK-ZQztvZCkn.png](https://cdn-images-1.medium.com/max/800/0*ppOSGK-ZQztvZCkn.png)

Bedavaya Değişim

### Bedavaya Değişim (Change for Free)

- Sabit fiyatlı bir kontratta sadece değişim bedava olduğunu belirtin.
...
Notlar, Scrum’ ın arkasındaki nedeni dize anlatmak için yazılmıştı. Bu bölüm de size kısaca nasılını açıklayacak.
...
![https://cdn-images-1.medium.com/max/800/0*pJIg5V9RpCzQWvfr.png](https://cdn-images-1.medium.com/max/800/0*pJIg5V9RpCzQWvfr.png)

**4. İş Listesi Yaratın:**

- Yaratın ve önceliklendirin.
- Sadece bir adet iş listesi vardır.
- Bu liste ürünün yaşam süresi boyunca var olur ve evrim geçirir.
- Ürün sahibi tüm paydaşlara ve ekibe hem insanların istediklerini hem de yapabilinecek olanı geliştirdiklerine emin olmak için danışmalıdır.
...
![https://cdn-images-1.medium.com/max/800/0*GVsDYW4jyFX-OG7u.jpg](https://cdn-images-1.medium.com/max/800/0*GVsDYW4jyFX-OG7u.jpg)
...
- Ekip İş Listesi’ nin en üstüne bakar ve bu Sprint’ te ne kadarını tamamlayabileceğini tahmin eder.
- Bu tahminlerin sayıları ekibin hızıdır.
- Scrum Ustası ve ekip bu rakamı her bir Sprint’ te arttırmaya çalışır.
- Sprint başladıktan sonra o Sprint’ te yapılmak üzere seçilenler değiştirilemez.

[https://cdn-images-1.medium.com/max/800/0*Grnq5sTK0IXsrcfN](https://cdn-images-1.medium.com/max/800/0*Grnq5sTK0IXsrcfN)

**7. İşi Görünür Kılın:**

- Bunu yapmanın en kolay yolu üç sütunlu bir Scrum Tahtası’ dır: Yapılacaklar, Devam Edenler ve Tamamlananlar.

![https://cdn-images-1.medium.com/max/800/0*Oeqy9zW3VkfQ2zZy.png](https://cdn-images-1.medium.com/max/800/0*Oeqy9zW3VkfQ2zZy.png)

**8. Günlük Stand-Up ya da Günlük Scrum:**

- Kalp atışıdır.
- Her gün aynı saatte yapılır.
- 15 dakşayı geçmeyecek şekildedir.
...
![https://cdn-images-1.medium.com/max/800/0*Xd9PRggo7rDEMCMl.jpg](https://cdn-images-1.medium.com/max/800/0*Xd9PRggo7rDEMCMl.jpg)

**9. Sprint’ in Gözden Geçirilmesi ya da Demosu:**

- Sprint’ te tamamlananların gösterildiği toplantıdır.
- Herkes katılabilir. Paydaşlar, yönetim, müşterile, herkes.
- Sadece “Tamamlanan” tanımına uyan şeyler gösterilir.

![https://cdn-images-1.medium.com/max/800/0*_5nQvGPvYcbwkuRD.PNG](https://cdn-images-1.medium.com/max/800/0*_5nQvGPvYcbwkuRD.PNG)
...
- Toplantı sonunda ekip ve Scrum Ustası bir sonraki Sprint’ te uygulayacakları bir gelişim üzerinde anlaşmaya varmalıdır.

![https://cdn-images-1.medium.com/max/800/0*JSu_UnjVaypiHUw_.jpg](https://cdn-images-1.medium.com/max/800/0*JSu_UnjVaypiHUw_.jpg)
